...
const ApproveRiders = () => {
  ...
  const handleApprove = rider => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        statusMutation.mutate({ id: rider._id, status: 'approved' });
      }
    });
  };
  ...
  const handleReject = rider => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        statusMutation.mutate({ id: rider._id, status: 'rejected' });
      }
    });
  };
                  ...
                  riders.map((rider, index) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-2 py-5">
                          <p className="truncate text-[11px] font-semibold text-[#4a5568]">
                            {rider.region}
                          </p>
                          <p className="mt-1 truncate text-[10px] text-gray-500">
                            {rider.district}
                        ...
                        <td className="px-2 py-5">
                          <p className="truncate text-[11px] font-medium text-[#4a5568]">
                            {rider.licenseNumber}
                          </p>
                        </td>
                          ...
                          {rider.status === 'pending' ? (
                            <div className="flex items-center justify-start gap-1.5">
                              <button
                                ...
                                className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-[#c6ef52] text-[#003b40] shadow-sm transition-all hover:bg-[#b9e83e] disabled:cursor-not-allowed disabled:opacity-50"
                              >
                              ...
                              <button
                                ...
                                className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg border border-red-200 bg-red-50 text-red-600 shadow-sm transition-all hover:bg-red-100 disabled:cursor-not-allowed disabled:opacity-50"
                              >
                                <FaTimes className="text-[11px]" />
                              </button>
                            </div>
                          ) : (
                            <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#f1f5f5] text-[#94a3b8]">
                              <FaCheck className="text-[11px]" />
                            </span>
                          )}
                        </td>
